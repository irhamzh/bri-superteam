...
export const createPGPeralatanIT = (formData, refresh) => async (dispatch) => {
  let ObjError = ''
  const paramsResponse = {}
  ...
  try {
    dispatch({ type: CREATE_PERALATAN_IT_LOADING, isLoading: true })
    // Call API
    const res = await Service.createPGPeralatanIT(formData)
    dispatch({ type: CREATE_PERALATAN_IT_SUCCESS, isLoading: false })
...
export const updatePGPeralatanIT = (formData, id, refresh) => async (dispatch) => {
  let ObjError = ''
  const paramsResponse = {}
  ...
  try {
    dispatch({ type: UPDATE_PERALATAN_IT_LOADING, isLoading: true })
    // Call API
    const res = await Service.updatePGPeralatanIT(formData, id)
    dispatch({ type: UPDATE_PERALATAN_IT_SUCCESS, isLoading: false })
...
export const deletePGPeralatanIT = (id, refresh) => async (dispatch) => {
  let ObjError = ''
  const paramsResponse = {}
  ...
  try {
    dispatch({ type: DELETE_PERALATAN_IT_LOADING, isLoading: true })
    // Call API
    const res = await Service.deletePGPeralatanIT(id)
    dispatch({ type: DELETE_PERALATAN_IT_SUCCESS, isLoading: false })
