  ...
  useEffect(() => {
    ;(async function getDataDashboard() {
      try {
        ...
        const resDataToday = await Service.getDashboardFinancialAdmin(paramsEncoded)
        Swal.close()
      ...
      <Col>
        <Card>
          <CardBody>
            <Row>
              <Col>
                <h4 className="text-primary text-center">Data Financial Admin Hari Ini</h4>
              </Col>
            </Row>
            <Row>
            ...
            >
              <Link
                to={`/dashboard/financial-admin/belum-berjalan?date=${today}`}
              ...
              <Link
                to={`/dashboard/financial-admin/proses-persetujuan?date=${today}`}
                style={{ textDecoration: 'none' }}
              >
              ...
              <Link
                to={`/dashboard/financial-admin/belum-selesai?date=${today}`}
                style={{ textDecoration: 'none' }}
              >
              ...
              <Link
                to={`/dashboard/financial-admin/selesai?date=${today}`}
                style={{ textDecoration: 'none' }}
              >
        ...
        <Card>
          <CardBody>
            ...
            >
              ...
              <Link
                to={`/dashboard/financial-admin/selesai${
                  monthYear ? `?monthYear=${monthYear}` : ''
                }`}
                style={{ textDecoration: 'none' }}
              >
