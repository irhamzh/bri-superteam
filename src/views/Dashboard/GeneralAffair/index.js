  ...
  useEffect(() => {
    ;(async function getDataDashboard() {
      try {
        ...
        const resDataToday = await Service.getDashboardGeneralAffair(paramsEncoded)
        Swal.close()
      ...
      <Col>
        <Card>
          <CardBody>
            <Row>
              <Col>
                <h4 className="text-primary text-center">Data General Affair Hari Ini</h4>
              </Col>
            </Row>
            <Row>
            ...
            >
              <Link
                to={`/dashboard/general-affair/belum-berjalan?date=${today}`}
              ...
              <Link
                to={`/dashboard/general-affair/proses-persetujuan?date=${today}`}
                style={{ textDecoration: 'none' }}
              >
              ...
              <Link
                to={`/dashboard/general-affair/belum-selesai?date=${today}`}
                style={{ textDecoration: 'none' }}
              >
              ...
              <Link
                to={`/dashboard/general-affair/selesai?date=${today}`}
                style={{ textDecoration: 'none' }}
              >
        ...
        <Card>
          <CardBody>
            ...
            >
              ...
              <Link
                to={`/dashboard/general-affair/belum-selesai${
                  monthYear ? `?monthYear=${monthYear}` : ''
                }`}
                style={{ textDecoration: 'none' }}
              >
              ...
              <Link
                to={`/dashboard/general-affair/selesai${
                  monthYear ? `?monthYear=${monthYear}` : ''
                }`}
                style={{ textDecoration: 'none' }}
              >
