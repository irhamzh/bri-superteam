...
class PublicCourse extends Component {
  initialValues = {
    ...
    suratPemanggilan: false,
    dataBrismart: false,
    anggaranKegiatan: false,
    fakturPajakBagiWapu: false,
  }
  ...
  render() {
    ...
    const columns = [
      ...
      {
        Header: 'Data Brismart',
        accessor: 'dataBrismart',
        filterable: false,
        headerClassName: 'wordwrap',
        Cell: (props) =>
          props.value ? (
      ...
      {
        Header: 'Faktur Pajak Bagi Wapu',
        accessor: 'fakturPajakBagiWapu',
        filterable: false,
        headerClassName: 'wordwrap',
        Cell: (props) =>
          props.value ? (
                    ...
                    <div style={{ textAlign: 'right' }}>
                      ...
                      >
                        <ExcelSheet data={data} name={pageName}>
                          ...
                          />
                          <ExcelColumn label="Periode" value={(col) => col.periode} />
                          <ExcelColumn
                          ...
                          <ExcelColumn
                            ...
                            value={(col) => (col.suratPemanggilan ? '✓' : '❌')}
                          />
                          <ExcelColumn
                            label="Data Brismart"
                            value={(col) => (col.dataBrismart ? '✓' : '❌')}
                          />
                          <ExcelColumn
                          ...
                          />
                          <ExcelColumn
                            label="Faktur Pajak Bagi Wapu"
                            value={(col) => (col.fakturPajakBagiWapu ? '✓' : '❌')}
                          />
                          {/* <ExcelColumn
