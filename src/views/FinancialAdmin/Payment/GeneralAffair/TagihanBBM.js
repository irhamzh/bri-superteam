...
class TagihanBBM extends Component {
  state = {
    isShow: false,
    columns: [],
  }
  ...
  initialValues = {
    ...
    typePayment: 'Tagihan BBM',
    // typePendidikan: 'Non Pendidikan',
    invoiceSPBUBermaterai: false,
    rekapStrukPerTransaksi: false,
    notaPembukuan: false,
  }
  ...
  componentDidMount() {
    ...
    const columns = [
      ...
      {
        Header: 'Invoice SPBU Bermaterai',
                    ...
                    <div style={{ textAlign: 'right' }}>
                      ...
                      >
                        <ExcelSheet data={data} name={pageName}>
                          ...
                          <ExcelColumn label="Kegiatan" value={(col) => col.kegiatan} />
                          <ExcelColumn
                            label="Invoice SPBU Bermaterai"
                            value={(col) => (col.invoiceSPBUBermaterai ? '✓' : '❌')}
                          />
                          <ExcelColumn
                            label="Rekap Struk Per Transaksi"
                            value={(col) => (col.rekapStrukPerTransaksi ? '✓' : '❌')}
                          />
                          <ExcelColumn
