...
class FADailyActivities extends Component{
    state = {
        isShow: false,
        columns: [],
    }
    ...
    handleSaveChanges = (values) => {
        ...
        const newObject = {...values, isChecked: false, dept: 'fixed_asset', }
...
withTableFetchQuery({
    API: (p) => Service.getDailyActivitiesByName("fixed_asset"),
    // console.log
