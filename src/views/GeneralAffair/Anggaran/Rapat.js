...
class AnggaranRapat extends Component {
  state = {
    tahun: '',
    bulan: '',
    isShow: false,
          ...
          <Col xs="12">
            ...
            >
              ...
              >
                {({ isSubmitting }) => (
                  <Form>
                    <ModalHeader toggle={modalForm.hide}>Anggaran Rapat</ModalHeader>
                    <ModalBody>
                      <FormGroup>
                        <Field
                          label="Kategori Anggaran"
