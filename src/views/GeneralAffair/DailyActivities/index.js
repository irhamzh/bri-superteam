...
class GADailyActivities extends Component{
    state = {
        isShow: false,
        columns: [],
    }
    ...
    handleSaveChanges = (values) => {
        ...
        const newObject = {...values, isChecked: false, dept: 'general_affair', }
...
withTableFetchQuery({
    API: (p) => Service.getDailyActivitiesByName("general_affair"),
    // console.log
