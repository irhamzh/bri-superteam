...
class Sosialisasi extends Component {
  initialValues = {
    typeKegiatan: 'Sosialisasi',
          ...
          <Col xs="12">
            ...
            >
              ...
              >
                {({ isSubmitting }) => (
                  <Form>
                    <ModalHeader toggle={modalForm.hide}>Data Kegiatan Sosialisasi</ModalHeader>
                    <ModalBody>
                      <FormGroup>
                        <Field
                          label="Nama Kegiatan"
