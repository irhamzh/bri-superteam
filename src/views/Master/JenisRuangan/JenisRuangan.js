...
import { deleteJenisRuangan } from '../../../modules/jenisRuangan/actions'
...
function JenisRuangan(props) {
  ...
  function handleDelete(e, state) {
    ...
    const { id } = state
    const { deleteJenisRuangan } = props

    AlertMessage.warning()
      .then((result) => {
        if (result.value) {
          deleteJenisRuangan(id, doRefresh)
        }
      })
      .catch((err) => {
...
JenisRuangan.propTypes = {
  auth: PropTypes.bool.isRequired,
  isLoading: PropTypes.bool,
  message: PropTypes.oneOfType([PropTypes.string, PropTypes.array, PropTypes.object]),
  className: PropTypes.oneOfType([PropTypes.string, PropTypes.array, PropTypes.object]),
  deleteJenisRuangan: PropTypes.func.isRequired,
...
const mapDispatchToProps = (dispatch) => ({
  deleteJenisRuangan: (id, refresh) => dispatch(deleteJenisRuangan(id, refresh)),
})
...
export default connect(
  ...
  withTableFetchQuery({
    API: (p) => Service.getJenisRuangan(p),
