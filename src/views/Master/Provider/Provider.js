...
import { deleteProvider } from '../../../modules/provider/actions'
...
const mapDispatchToProps = (dispatch) => ({
  deleteProvider: (id, refresh) => dispatch(deleteProvider(id, refresh)),
})
