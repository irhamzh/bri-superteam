...
import { deletePartner } from '../../../modules/partners/actions'
...
const mapDispatchToProps = (dispatch) => ({
  deletePartner: (id, refresh) => dispatch(deletePartner(id, refresh)),
})
