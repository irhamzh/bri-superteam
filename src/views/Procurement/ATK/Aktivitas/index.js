...
class Aktivitas extends Component {
  ...
  render() {
    ...
    const columns = [
      ...
      {
        Header: 'Konfirmasi ke LOP',
        accessor: 'konfirmasiLOP',
        filterable: false,
      },
      {
        Header: 'Aksi',
                    ...
                    <ModalBody>
                      ...
                      <FormGroup>
                        <Field
                          ...
                          name="barangPesanan"
                          isRequired
                          placeholder="Masukkan Barang Pesanan"
                          component={CfInput}
                        />
                      </FormGroup>
