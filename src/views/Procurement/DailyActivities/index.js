...
class PRDailyActivities extends Component{
    state = {
        isShow: false,
        columns: [],
    }
    ...
    handleSaveChanges = (values) => {
        ...
        const newObject = {...values, isChecked: false, dept: 'procurement', }
...
withTableFetchQuery({
    API: (p) => Service.getDailyActivitiesByName("procurement"),
    // console.log
